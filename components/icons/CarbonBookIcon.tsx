...
const CarbonBookIcon: React.FC = () => {
  return (
    ...
    >
      <g id="carbon:book">
        <path id="Vector" d="M42.75 22.5H58.5V27H42.75V22.5Z" fill={Colors.primary} />
        <path
          id="Vector_2"
          d="M42.75 33.75H58.5V38.25H42.75V33.75Z"
          fill={Colors.primary}
        />
        <path id="Vector_3" d="M42.75 45H58.5V49.5H42.75V45Z" fill={Colors.primary} />
        <path id="Vector_4" d="M13.5 22.5H29.25V27H13.5V22.5Z" fill={Colors.primary} />
        <path
          id="Vector_5"
          d="M13.5 33.75H29.25V38.25H13.5V33.75Z"
          fill={Colors.primary}
        />
        <path id="Vector_6" d="M13.5 45H29.25V49.5H13.5V45Z" fill={Colors.primary} />
        <path
          id="Vector_7"
